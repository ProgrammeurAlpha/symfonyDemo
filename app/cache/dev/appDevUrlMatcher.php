...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // admin_index
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/admin/post/?$#s', $pathinfo, $matches)) {
        ...
        // admin_post_new
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/admin/post/new$#s', $pathinfo, $matches)) {
        ...
        // admin_post_show
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/admin/post/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'HEAD'));
        ...
        // admin_post_edit
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/admin/post/(?P<id>\\d+)/edit$#s', $pathinfo, $matches)) {
            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
        ...
        // admin_post_delete
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/admin/post/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        // blog_index
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/blog/?$#s', $pathinfo, $matches)) {
            if (substr($pathinfo, -1) !== '/') {
        ...
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/blog/page/(?P<page>\\d+)$#s', $pathinfo, $matches)) {
        ...
        // blog_post
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/blog/posts/(?P<slug>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        // comment_new
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/blog/comment/(?P<postSlug>[^/]++)/new$#s', $pathinfo, $matches)) {
        ...
        // security_login_form
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/login$#s', $pathinfo, $matches)) {
        ...
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/login_check$#s', $pathinfo, $matches)) {
        ...
        // security_logout
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)/logout$#s', $pathinfo, $matches)) {
        ...
        // homepage
        if (preg_match('#^/(?P<_locale>en|fr|de|es|cs|ru|uk|ro|pt_BR|pl|it|ja|id)?$#s', $pathinfo, $matches)) {
